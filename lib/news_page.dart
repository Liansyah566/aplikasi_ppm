...
class _NewsPageState extends State<NewsPage> {
  ...
  String API_KEY = "fa9b146756d54e4e9bb33456b7e80818";
  ...
  Future<List<Article>> getinitNewsData({int? page}) async {
    NewsAPI newsAPI = NewsAPI(apiKey: API_KEY);
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              CircleAvatar(
                radius: 50,
                child: Text( FirebaseAuth.instance.currentUser!.displayName![0] ?? "",style: TextStyle(fontSize: 30),),
              ),
              const SizedBox(
                height: 10,
              ),
